import sys
from  novo_pyqt5.design import *
from PyQt5.QtWidgets import QMainWindow, QApplication, QFileDialog
from PyQt5.QtGui import QPixmap

class RedimensionarImg(QMainWindow, Ui_MainWindow):
    ...
    def abrir_imagem(self):
        imagem, _ = QFileDialog.getOpenFileName(
            self.centralwidget,
            'Abrir imagem',
            r'D:/Documentos/Imagens/amsterdam',
...
if __name__ == '__main__':
    ...
    redimensionar_img = RedimensionarImg()
    redimensionar_img.show()
    qt.exec_()